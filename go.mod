...
require (
	...
	gitlab.com/gitlab-org/api/client-go/v2 v2.55.0
...
require (
	...
	github.com/controlplaneio-fluxcd/flux-operator v0.55.0 // indirect
	...
	github.com/fluxcd/pkg/kustomize v1.38.0 // indirect
