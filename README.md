...
| `KONFLATE_APP_CLIENT_ID`            | _(none)_      | GitHub App client id (**GitHub only**) — the preferred write identity. With the key below, konflate mints short-lived installation tokens instead of carrying a standing PAT; the installation is auto-detected from the repo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
