...
![Version](https://img.shields.io/static/v1?label=Version&message=0.6.2&color=informational&style=flat-square) <!-- x-release-please-version -->
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion](https://img.shields.io/static/v1?label=AppVersion&message=0.6.2&color=informational&style=flat-square) <!-- x-release-please-version -->
